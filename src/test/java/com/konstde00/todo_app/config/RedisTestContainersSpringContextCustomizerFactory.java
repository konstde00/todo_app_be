...
public class RedisTestContainersSpringContextCustomizerFactory implements ContextCustomizerFactory {
  ...
  private Logger log =
      LoggerFactory.getLogger(RedisTestContainersSpringContextCustomizerFactory.class);
  ...
  public ContextCustomizer createContextCustomizer(
    ...
    return (context, mergedConfig) -> {
      ...
      EmbeddedRedis redisAnnotation =
          AnnotatedElementUtils.findMergedAnnotation(testClass, EmbeddedRedis.class);
