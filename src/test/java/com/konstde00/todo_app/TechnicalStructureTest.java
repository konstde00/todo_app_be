package com.konstde00.todo_app;
...
@AnalyzeClasses(packagesOf = TodoAppBeApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
  ...
  static final ArchRule respectsTechnicalArchitectureLayers =
      layeredArchitecture()
          ...
          .ignoreDependency(belongToAnyOf(TodoAppBeApp.class), alwaysTrue())
          .ignoreDependency(
              alwaysTrue(),
              belongToAnyOf(
                  com.konstde00.todo_app.config.Constants.class,
                  com.konstde00.todo_app.config.ApplicationProperties.class));
}
