...
#    { name : "MYSQL_URL", value: aws_rds_cluster_instance.todo_app_db_instance.endpoint },
#    { name : "S3_BUCKET_URL", value : aws_s3_bucket.todo_app_user_attachments.bucket }
#    #    { name : "REDIS_HOST", value : data.aws_elasticache_cluster.app_cache_cluster.cache_nodes.0.address },
#    #    { name : "REDIS_PORT", value : data.aws_elasticache_cluster.app_cache_cluster.cache_nodes.0.port },
#  ]
#
#  task_role_arn = aws_iam_role.todo-app-api-role.arn
#  execution_role = aws_iam_role.todo-app-api-role.arn
#  vpc_external_subnet_ids = module.main_vpc.public_subnets
#  vpc_internal_subnet_ids = module.main_vpc.private_subnets
#}
